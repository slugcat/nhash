 ...
 * @since   1.2
 */
// TODO rename to something else once correctness tests are run
public class HashFieldHashMap<K,V> extends AbstractMap<K,V>
   ...
   */
  public HashFieldHashMap(int initialCapacity, float loadFactor) {
   ...
   * @throws IllegalArgumentException if the initial capacity is negative.
   */
  public HashFieldHashMap(int initialCapacity) {
   ...
   */
  public HashFieldHashMap(Map<? extends K, ? extends V> m) {
  ...
  final class KeySet extends AbstractSet<K> {
    ...
    public final void clear()               { HashFieldHashMap.this.clear(); }
    ...
    public final Spliterator<K> spliterator() {
      return new KeySpliterator<>(HashFieldHashMap.this, 0, -1, 0, 0);
    }
  ...
  final class Values extends AbstractCollection<V> {
    ...
    public final Spliterator<V> spliterator() {
      return new ValueSpliterator<>(HashFieldHashMap.this, 0, -1, 0, 0);
    }
  ...
  final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
    ...
    public final Spliterator<Map.Entry<K,V>> spliterator() {
      return new EntrySpliterator<>(HashFieldHashMap.this, 0, -1, 0, 0);
    }
  ...
  @Override
  public Object clone() {
    HashFieldHashMap<K,V> result;
    try {
      result = (HashFieldHashMap<K,V>)super.clone();
  ...
  private void readObject(ObjectInputStream s)
    ...
    HashFieldHashMap.UnsafeHolder.putLoadFactor(this, lf);
  ...
  private static final class UnsafeHolder {
    ...
    private static final long LF_OFFSET
        = unsafe.objectFieldOffset(HashFieldHashMap.class, "loadFactor");
    static void putLoadFactor(HashFieldHashMap<?, ?> map, float lf) {
  ...
  static class HashMapSpliterator<K,V> {
    final HashFieldHashMap<K,V> map;
    ...
    HashMapSpliterator(HashFieldHashMap<K,V> m, int origin,
                       int fence, int est,
  ...
  static final class KeySpliterator<K,V>
    ...
    KeySpliterator(HashFieldHashMap<K,V> m, int origin, int fence, int est,
                   int expectedModCount) {
  ...
  static final class ValueSpliterator<K,V>
    ...
    ValueSpliterator(HashFieldHashMap<K,V> m, int origin, int fence, int est,
                     int expectedModCount) {
      super(m, origin, fence, est, expectedModCount);
    }
  ...
  static final class EntrySpliterator<K,V>
    ...
    EntrySpliterator(HashFieldHashMap<K,V> m, int origin, int fence, int est,
                     int expectedModCount) {
      super(m, origin, fence, est, expectedModCount);
    }
   ...
   * Entry is now treated as intermediary node class
   * that can also be converted to tree form. The name of this
   * class, Entry, is confusing in several ways in its
  ...
  static final class TreeNode<K,V> extends Entry<K,V> {
     ...
     * this node.
     */
    final Node<K,V> untreeify(HashFieldHashMap<K,V> map) {
     ...
     */
    final TreeNode<K,V> putTreeVal(HashFieldHashMap<K,V> map, Node<K,V>[] tab,
                                   int h, K k, V v) {
      Class<?> kc = null;
     ...
     */
    final void removeTreeNode(HashFieldHashMap<K,V> map, Node<K,V>[] tab,
                              boolean movable) {
      int n;
     ...
     */
    final void split(HashFieldHashMap<K,V> map, Node<K,V>[] tab, int index, int bit) {
      TreeNode<K,V> b = this;
   ...
   * @since 19
   */
  public static <K, V> HashFieldHashMap<K, V> newHashMap(int numMappings) {
    if (numMappings < 0) {
      throw new IllegalArgumentException("Negative number of mappings: " + numMappings);
    }
    return new HashFieldHashMap<>(calculateHashMapCapacity(numMappings));
  }
